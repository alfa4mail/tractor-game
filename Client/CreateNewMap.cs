...
namespace WindowsApplication2
{
	public class CreateNewMap : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelChoose.Text = "¬ыберите  размер игрового пол€ по горизонтали(X) и вертикали(Y):";
			// 
			// labelX
			// 
			...
			this.labelSize.Text = "–азмеры игрового пол€:";
			// 
			// labelSizeOfMap
			// 
			...
			this.checkBoxDrawBorder.Text = "јвтоматически нарисовать границы игрового пол€";
			...
			this.Text = "ѕараметры новой карты";
